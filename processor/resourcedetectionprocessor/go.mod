...
>>>>>>> 8ed5eeaccb (Add Cancel To Context For IMDS Retry To Prevent ECS Hanging Issue)
...
replace github.com/amazon-contributing/opentelemetry-collector-contrib/config/confighttp => ../../config/confighttp
