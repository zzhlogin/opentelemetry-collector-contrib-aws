...
//  failed to load TLS config: failed to load CA CertPool: failed to load CA /doesnt/exist: open /doesnt/exist: no such file or directory

// ^failed to load TLS config: failed to load CA CertPool File: failed to load cert /doesnt/exist:

// ^failed to load TLS config: failed to load CA CertPool .*
